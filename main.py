...
class MyServer(BaseHTTPRequestHandler):
    ...
    def __get_html_content(self):
        """
        Метод для возврата содержания веб страницы в формате html
        :return:
        """
        return """
        <!DOCTYPE html>
                ...
                <div class="col-4">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="w-100 btn btn-lg btn-outline-success">Купить</button>
                        </div>
                    </div>
                </div>
                <div class="col-4">
                ...
                <div class="col-12">
                    ...
                    <p class="d-inline-flex gap-1">
                        <a class="btn btn-primary" data-bs-toggle="collapse" href="#multiCollapseExample1" role="button"
                           aria-expanded="false" aria-controls="multiCollapseExample1">Где купить?</a>
                        ...
                        <button class="btn btn-primary" type="button" data-bs-toggle="collapse"
                                ...
                                aria-controls="multiCollapseExample2">Какая гарантия?
                        </button>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="collapse multi-collapse" id="multiCollapseExample1">
                                <div class="card card-body">
                                    Купить можно в нашем интернет магазине, отправив имя и email через форму,
                                    расположенную на главной странице сайта. Наш менеджер с вами свяжется и все подробно
                                    объяснит.
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="collapse multi-collapse" id="multiCollapseExample2">
                                <div class="card card-body">
                                    Эту информацию вам скажет менеджер. Оставьте свои контактные данные через форму,
                                    расположенную на главной странице сайта.
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="collapse multi-collapse" id="multiCollapseExample3">
                                <div class="card card-body">
                                    Гарантия год с момента доставки товара
                                </div>
                            </div>
                        </div>
                    </div>
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Корректный способ остановить сервер в консоли через сочетания клавишь Cntrl + C
        pass
